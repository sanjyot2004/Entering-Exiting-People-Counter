...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if currentClass == "person" and conf > 0.3:
                    #cvzone.putTextRect(img,f'{currentClass} {conf}',(max(0, x1+10), max(35, y1)),scale=0.8, thickness=1, offset=3)
    ...
    for result in resultsTracker:
        ...
        cvzone.putTextRect(img, f'{int(id)}', (max(0, x1 + 10), max(35, y1)), scale=2, thickness=3,
                           offset=10)
